...
public class SwaggerConfig {
    ...
    public Docket postsApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ssafy.dokcho2.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("DokCho2 Service API")
                .description("E203 Final Project")
                .version("1.0").build();
    }
